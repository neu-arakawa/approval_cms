<?php
define('SITE_NAME', '関西医科大学附属病院');                                              // サイト名
...
define('MEDICAL_SCHEDULE_PRINT_PATH','/upload/medical_schedule_print.pdf');

// ブロックエディタ書式
$config['block_editor_style_formats'] =  
	    array(
	    	array(
	    		'title' => "文字色",
	    		'items' => array(
